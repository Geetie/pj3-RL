...
def parse_args():
    ...
    parser.add_argument("--amp", type=lambda x: bool(strtobool(x)), default=True, nargs="?", const=True,
...
if __name__ == "__main__":
    ...
    # AMP 自动混合精度
    scaler = torch.amp.GradScaler("cuda" if torch.cuda.is_available() else "cpu", enabled=args.amp)
